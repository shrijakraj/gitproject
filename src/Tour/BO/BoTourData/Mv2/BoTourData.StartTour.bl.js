...
function startTour(){
    ...
    if (
      !Utils.isDefined(ApplicationContext.get("runningTourId")) ||
      Utils.isEmptyString(ApplicationContext.get("runningTourId"))
    ) {
      ...
      if (tourStatus === "initial" || tourStatus === "open") {
        ...
        ApplicationContext.set("runningTourId", me.getPKey());
        me.setEARights();
      }
    }
