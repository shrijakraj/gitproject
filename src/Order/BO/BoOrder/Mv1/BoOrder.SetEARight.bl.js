...
if (Utils.isDefined(me.getBoOrderMeta())) {
  ...
  if(me.getBoOrderMeta().getSdoSubType() == "OrderEntry" && (me.getBoOrderMeta().getDocTaType() == "VanSalesCashInvoice" || 
  ...
  if(me.getIsOrderPaymentRelevant() === '0') {
    ...
    if(me.getDocTaType() === "CashOrder" || me.getDocTaType() === "InvoiceCashInvoice" || me.getDocTaType() === "VanSalesCashInvoice") {
...
if(!Utils.isEmptyString(me.getCallInContext_clbMainPKey())) {
  promise = Facade.getObjectAsync("BoCall", me.getQueryBy("pKey", me.getCallInContext_clbMainPKey()))
    ...
    if (Utils.isDefined(boCall) && (isDSDMode || me.getBoOrderMeta().getSdoSubType() === "Delivery")) {
      var bCallIsReadOnly = boCall.clbStatus === "Completed" || boCall.clbStatus === "Canceled" || (isDSDMode && boCall.clbStatus === "Planned");
      if(bCallIsReadOnly) {
